...
/**
 * Payload-объект SDK `AudioAttachment` для подготовки данных запроса.
 ...
 */
final class AudioAttachment implements AttachmentPayloadInterface
{
    /**
     * Создаёт объект `AudioAttachment`.
    ...
    /**
     * Создаёт audio attachment по токену загрузки.
