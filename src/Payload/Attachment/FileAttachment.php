...
/**
 * Payload-объект SDK `FileAttachment` для подготовки данных запроса.
 ...
 */
final class FileAttachment implements AttachmentPayloadInterface
{
    /**
     * Создаёт объект `FileAttachment`.
    ...
    /**
     * Создаёт file attachment по токену загрузки.
