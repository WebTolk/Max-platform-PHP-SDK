...
/**
 * Payload-объект SDK `VideoAttachment` для подготовки данных запроса.
 ...
 */
final class VideoAttachment implements AttachmentPayloadInterface
{
    /**
     * Создаёт объект `VideoAttachment`.
    ...
    /**
     * Создаёт video attachment по токену загрузки.
